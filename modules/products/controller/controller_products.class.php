...
include ($_SERVER['DOCUMENT_ROOT'] . "/products_ORM_list_products/modules/products/utils/functions_products.inc.php");
include ($_SERVER['DOCUMENT_ROOT'] . "/products_ORM_list_products/utils/upload.php");
include ($_SERVER['DOCUMENT_ROOT'] . "/products_ORM_list_products/utils/common.inc.php");
$path = $_SERVER['DOCUMENT_ROOT'] . '/products_ORM_list_products/';
           ...
           'origin' => $result['datos']['origin'],
            ...
            'departure_date' => $result['datos']['departure_date'],
        	  ...
        	  'avatar' => $result_avatar['datos']
				...
				/////////////////insert into BD////////////////////////
        $arrValue = false;
        $path_model = $_SERVER['DOCUMENT_ROOT'] . '/products_ORM_list_products/modules/products/model/model/';
